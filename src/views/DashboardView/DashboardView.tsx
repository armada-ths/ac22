                    ...
                    <div className='dashboard-spotlight'>
                        <div className='spotlight-header'>
                            ...
                            <div className='spotlight-right arrows'>
                                {spotlight!==0 && <img src={arrow_left_white} alt={"arrow right starred page"} onClick={() => { setSpotlight(spotlight - 1);}}></img>}
                                {spotlight!==14 && <img src={arrow_right_white} alt={"arrow right starred page"} onClick={() => { setSpotlight(spotlight + 1);}}></img>}
                            </div>
                        </div>
                        <div className='spotlight-info' style={{backgroundImage: companies[spotlight].image}}>
                ...
                <div className='dashboard-cards-body'>
                    <div className='dashboard-cards-header'>
                        ...
                        <div className='arrows'>
                            ...
                            {a !== 12 && <img src={arrow_right} alt={"arrow right starred page"} onClick={() => { setA(a + 3);}} />}
                        </div>
                    </div>
